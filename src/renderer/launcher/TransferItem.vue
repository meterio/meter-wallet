    ...
    <v-list>
      <v-list-tile avatar>
        <v-list-tile-avatar :size="40">
          <v-icon style="font-size: 19px" color="green lighten-1" v-if="isIn"
            >mdi-arrow-right-thick</v-icon
          >
          <v-icon style="font-size: 19px" color="red darken-1" v-else
            ...
            <v-layout>
              <v-flex xs6>
                ...
                >
                  ...
                  <span v-if="!isIn && isBridgeTrade" style="marginleft: 6px">
                    <a
                      @click="jumpToInsightTrade(item.meta.txID)"
                      href="javascript:;"
                      >Trade Details</a
                    >
                  </span>
