  ...
  <v-layout column align-center>
    <v-layout column style="max-width: 1000px; width: 100%">
      <div class="pa-3">
        ...
        <v-layout justify-center>
          <v-btn small class="caption" color="primary" @click="onCreate"
            >New</v-btn
          >
          <v-btn small class="caption" color="primary" @click="onImport"
            >Import</v-btn
          >
          ...
          <router-link tag="span" to="/auction/bid">
            <v-btn small class="caption" color="primary">Bid</v-btn>
          </router-link>
          <router-link tag="span" to="/staking/uncandidate">
            <v-btn small class="caption" color="primary">Uncandidate</v-btn>
          </router-link>
          <router-link tag="span" to="/staking/bound">
            <v-btn small class="caption" color="primary">Bound</v-btn>
          </router-link>
          <router-link tag="span" to="/staking/unbound">
            <v-btn small class="caption" color="primary">Unbound</v-btn>
          </router-link>
          <router-link tag="span" to="/staking/delegate">
            <v-btn small class="caption" color="primary">Delegate</v-btn>
          </router-link>
          <router-link tag="span" to="/staking/undelegate">
            <v-btn small class="caption" color="primary">Undelegate</v-btn>
          </router-link>
          -->
        </v-layout>
      </div>
